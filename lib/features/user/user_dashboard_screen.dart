...
import 'add_plant_bottom_sheet.dart';
...
class _UserDashboardScreenState extends State<UserDashboardScreen> {
  ...
  List<Widget> get _pages => [
    DashboardPage(userName: _userName, userEmail: _userEmail),
    const PlantsPage(),
    const InsightsPage(),
  ];
  ...
  Future<void> _loadUserInfo() async {
    try {
      ...
      if (user != null) {
        setState(() {
          _userName = user.userMetadata?['full_name'] ?? user.email?.split('@')[0] ?? 'User';
              ...
              child: Center(
                child: GestureDetector(
                  onTap: () {
                    ...
                    Navigator.of(context).pushNamed('/water-level-test');
                  },
...
class InsightsPage extends StatelessWidget {
                  ...
                  children: [
                    Text(
                      ...
                      style: GoogleFonts.inter(
                        fontSize: 24,
                        fontWeight: FontWeight.w800,
                        color: const Color(0xFF1F2937), // Dark gray for better contrast
                      ),
                    ),
                    const SizedBox(height: 8),
                    Text(
                      'Monitor your hydroponic system performance',
                      style: GoogleFonts.inter(
                        fontSize: 14,
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildActivityItem(
                      icon: Icons.science,
                      title: 'Nutrient levels updated',
                      subtitle: 'pH balanced at 6.5',
                      time: '5 hours ago',
                      color: const Color(0xFF10B981),
                    ),
                    const SizedBox(height: 12),
                    _buildActivityItem(
                      icon: Icons.eco,
                      title: 'Plant growth monitored',
                      subtitle: 'Lettuce showing healthy growth',
                      time: '1 day ago',
                    ...
                    _buildActivityItem(
                      ...
                      subtitle: 'All sensors functioning properly',
                      time: '2 days ago',
                      color: const Color(0xFFF59E0B),
                    ),
                    const SizedBox(height: 12),
                    _buildActivityItem(
                      ...
                      subtitle: '15% increase in plant height',
                      time: '3 days ago',
                      color: const Color(0xFF10B981),
                    ),
                  ],
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      padding: const EdgeInsets.all(20),
                      decoration: BoxDecoration(
                        color: Colors.white.withOpacity(0.85), // Increased opacity for better contrast
                        borderRadius: BorderRadius.circular(16),
                        border: Border.all(
        ...
        children: [
          ...
          Text(
            ...
            style: GoogleFonts.inter(
              fontSize: 20,
              fontWeight: FontWeight.w800,
              color: const Color(0xFF1F2937), // Dark gray for readability
            ),
          ),
          const SizedBox(height: 4),
          Text(
  ...
  static Widget _buildActivityItem({
    ...
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: Colors.white.withOpacity(0.8), // Increased opacity for better contrast
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
          color: Colors.white.withOpacity(0.3),
          width: 1,
