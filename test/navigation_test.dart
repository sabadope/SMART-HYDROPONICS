...
void main() {
  group('Navigation Tests', () {
    ...
    testWidgets('CTA button navigates to plant center', (WidgetTester tester) async {
      ...
      // Should find PlantCenterPage in navigation stack
      expect(find.byType(PlantCenterPage), findsOneWidget);
    });

    testWidgets('Navigation preserves state', (WidgetTester tester) async {
      ...
      // Should be on plant center page
      expect(find.byType(PlantCenterPage), findsOneWidget);
    ...
    testWidgets('Back navigation works', (WidgetTester tester) async {
      ...
      // Should be back to root scaffold
    ...
    testWidgets('Extend body allows full screen backgrounds', (WidgetTester tester) async {
      await tester.pumpWidget(const MaterialApp(home: RootScaffold()));
